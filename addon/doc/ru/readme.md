...
* Код дополнения стал более надёжным с помощью Pyright (проверка
  статического типа Python).
* Улучшены выделение звука, уровень масштабирования и объявления о позиции
  дорожки в GoldWave 7.
